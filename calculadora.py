...
def lucro():
    ...
    app_ = Label(frame_dados,text="Entre os detalhes do produto",compound=LEFT, padx=5, relief=FLAT, anchor=NW, font=('Verdana 11'),bg=co1, fg=co4)
    app_.place(x=0, y=10)
    ...
    # Botao Calcular--------------------
    img_calcular = Image.open('logo.png')
